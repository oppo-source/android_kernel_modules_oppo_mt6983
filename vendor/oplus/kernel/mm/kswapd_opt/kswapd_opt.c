...
#define CONFIG_KSWAPD_LOAD_STAT 1
...
#endif
#if IS_ENABLED(CONFIG_KSWAPD_LOAD_STAT)
#include <trace/hooks/vmscan.h>
#include <trace/events/vmscan.h>
#endif

#if IS_ENABLED(CONFIG_ALLOC_ORDER_STAT) || IS_ENABLED(CONFIG_ALLOC_ADJUST_FLAGS) || IS_ENABLED(CONFIG_KSWAPD_LOAD_STAT)
#define KBUF_LEN 10
